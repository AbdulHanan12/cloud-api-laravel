...
<section id="faq" class="py-16 bg-white md:py-20 lg:py-24">
    <div class="max-w-5xl px-12 mx-auto xl:px-0">
        ...
        <h2 class="text-3xl font-black md:text-4xl lg:text-6xl xl:text-7xl">{{ __('wpbox.fr_as_qu')}}</h2>
        <p class="mt-4 text-xl font-thin text-gray-700 lg:text-2xl">{{ __('wpbox.faq_subtitle')}}</p>
