...
class ContactsAndMessagesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $replies = [
            ...
            [
                "name" => "Menu Options",
                "text" => "We offer a variety of pizza options including Margherita, Pepperoni, Hawaiian, and more. You can check our full menu on our website. https://zebra-qr.com/leukapizza",
                "trigger" => "menu"
            ],
            [
                "name" => "Price",
                "text" => "You can check our prices on our online menu. https://zebra-qr.com/leukapizza",
                "trigger" => "price"
            ],
            [
                "name" => "Delivery Service",
                "text" => "Yes, we offer delivery services. You can place an order online or call us at [phone number] to have your favorite pizza delivered to your doorstep.",
                "trigger" => "delivery"
            ],
            [
                "name" => "Special Offers",
                "text" => "We have special offers on Tuesdays and Thursdays. You can get a discount on a large pizza when you order online. Do not miss out!",
                "trigger" => "special offers"
            ],
            [
                "name" => "Vegetarian Options",
                "text" => "We have a range of delicious vegetarian pizzas for our vegetarian customers. Just ask for our vegetarian menu when you order.",
                "trigger" => "vegetarian"
            ],
            [
                "name" => "Gluten-Free Options",
                "text" => "Yes, we offer gluten-free pizza crust for customers with dietary restrictions. You can request it when you place your order.",
                "trigger" => "gluten-free"
            ],
            [
                "name" => "Payment Methods",
                "text" => "We accept cash, credit cards, and online payment methods for your convenience.",
                "trigger" => "payment methods"
            ],
            [
                "name" => "Catering Services",
                "text" => "We provide catering services for events and parties. Please contact us in advance to discuss your catering needs.",
                "trigger" => "catering"
            ],
            [
                "name" => "Feedback and Reviews",
                "text" => "We value your feedback! You can leave reviews on our website or social media platforms. Your opinion matters to us.",
                "trigger" => "feedback"
            ],
            [
                "name" => "Contact Information",
                "text" => "You can reach us at [phone number] or visit our website for more information. Feel free to get in touch with any questions or concerns.",
                "trigger" => "contact"
            ],
            [
                "name" => "Script info",
